...
export const ACTIVE_MUSIC_REPLY_CONTEXT_LINE =
  "Music is live right now. If you answer without claiming the floor with music_reply_handoff, favor a quick reaction or short answer unless the moment clearly wants more.";
...
export const MUSIC_REPLY_HANDOFF_POLICY_LINE =
  "Use music_reply_handoff with mode=pause or duck when music is active and you want only this reply to take the floor temporarily. Runtime auto-restores playback after you finish. Use music_pause only when playback should remain paused beyond the reply.";
