...
// Keep playback buffers tight so we prioritize low-latency speech over long buffered lag.
export const AUDIO_PLAYBACK_STREAM_HIGH_WATER_MARK_BYTES = DISCORD_PCM_FRAME_BYTES * 64;
export const AUDIO_PLAYBACK_QUEUE_WARN_BYTES = DISCORD_PCM_FRAME_BYTES * 80;
export const AUDIO_PLAYBACK_QUEUE_HARD_MAX_BYTES = DISCORD_PCM_FRAME_BYTES * 120;
export const AUDIO_PLAYBACK_QUEUE_ABSOLUTE_MAX_BYTES = DISCORD_PCM_FRAME_BYTES * 160;
