...
export const AUDIO_PLAYBACK_STREAM_HIGH_WATER_MARK_BYTES = DISCORD_PCM_FRAME_BYTES * 192;
export const AUDIO_PLAYBACK_QUEUE_WARN_BYTES = DISCORD_PCM_FRAME_BYTES * 320;
export const AUDIO_PLAYBACK_QUEUE_HARD_MAX_BYTES = DISCORD_PCM_FRAME_BYTES * 480;
export const AUDIO_PLAYBACK_QUEUE_ABSOLUTE_MAX_BYTES = DISCORD_PCM_FRAME_BYTES * 960;
