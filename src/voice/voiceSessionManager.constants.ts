...
export const REALTIME_ASSISTANT_TTS_BACKPRESSURE_PAUSE_SAMPLES = 48_000 * 4;
export const REALTIME_ASSISTANT_TTS_BACKPRESSURE_RESUME_SAMPLES = 48_000 * 2.5;
...
export const VOICE_TURN_PROMOTION_STRONG_LOCAL_PEAK_MIN = 0.06;
export const VOICE_TURN_PROMOTION_STRONG_LOCAL_ACTIVE_RATIO_MIN = 0.14;
...
const VOICE_FALLBACK_NOISE_GATE_MAX_CLIP_MS = 1800;
...
const NON_DIRECT_REPLY_MIN_SILENCE_MS = 2300;
