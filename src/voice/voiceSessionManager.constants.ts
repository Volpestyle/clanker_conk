...
export const REALTIME_TURN_QUEUE_MAX = 3;
export const REALTIME_TURN_STALE_SKIP_MS = 2200;
export const REALTIME_TURN_COALESCE_WINDOW_MS = 1200;
export const REALTIME_TURN_COALESCE_MAX_BYTES = 24_000 * 2 * 8;
...
export const DISCORD_PCM_FRAME_MS = 20;
